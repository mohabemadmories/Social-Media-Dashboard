...
* **Data Processing:** I handled a dataset with over 2 million impressions and 216k likes. I used DAX to calculate growth rates and engagement percentages to make the data more meaningful.
...
## Tools used
* **Power BI / Tableau** for the visualization.
* **DAX** for custom measures and data transformation[cite: 39].

## Final Dashboard
![Social Media Dashboard](Social_Media.png)
